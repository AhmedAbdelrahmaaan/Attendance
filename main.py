            ...
            if Confirm:
                ...
                with st.form("survey_form"):
                  ...
                  # 13. في حالة الاجابة ب لا هل عندك سجل تجاري وبطاقة ضريبية سارية ومحتاج تشتغل بيهم ؟
                    st.session_state.has_commercial_register = st.radio("في حالة الاجابة ب لا هل عندك سجل تجاري وبطاقة ضريبية سارية ومحتاج تشتغل بيهم ؟",
                                                                  ["نعم", "لا", "متعامل فعلا","مكود ولا يعمل حاليا"])
